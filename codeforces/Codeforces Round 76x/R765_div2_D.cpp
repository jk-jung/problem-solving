...
void calc(vi &v, int mask = 0) {
    ...
    for (auto i: v) {
        ...
        int t2 = x == 0 ? 0 : 31 - __builtin_clz(x ^ mask);
        if (t2 == t) w[t2].pb(i);
        else if(t2 < t) w[0].pb(i);
    }
...
/*
59 15
2 14 12 10 4 14 14 4 0 14 0 8 0 2 0 0 14 6 12 2 12 6 4 2 14 4 14 0 10 4 6 6 0 0 10 12 12 2 12 4 6 0 0 14 2 12 2 4 0 0 2 0 14 10 14 2 0 10 14
 */